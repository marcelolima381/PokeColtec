 ...
 */
public class TypeDeserializer implements JsonDeserializer<Tipo>{
    
    @Override
    public Tipo deserialize(JsonElement je, Type type, JsonDeserializationContext jdc) throws JsonParseException {
     ...
     //   System.out.println("VETOR DOS POKEMONS: "+jsonPokemonsArray);
        ...
        for (int i = 0; i < pokes.length; i++) {
          // System.out.println(jsonPokemonsArray.get(i));
           ...
           TipoAbs t = gson.fromJson(jsonPokemonsArray.get(i), TipoAbs.class);
          // System.out.println(t.toString());

           n.add(t.pokemon.getName());
